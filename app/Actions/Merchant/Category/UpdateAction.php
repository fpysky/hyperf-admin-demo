...
use App\Request\Merchant\Category\UpdateRequest;
...
class UpdateAction extends AbstractAction
{
    ...
    /**
     * @api {put} /merchant/category  编辑分类
     * @apiDescription 编辑分类  yulu 2023/4/4
     * @apiName 编辑分类
     * @apiGroup 商家管理-商家分类
     * @apiVersion 1.0.0
     * @apiUse headers
     ...
     */
    #[PutMapping(path: '/merchant/category')]
    public function handle(UpdateRequest $request): ResponseInterface
    {
        ...
        $data = [];
        $res = $this->categoryService->edit($id, $parentId, $categoryName, $iconUrl, $sortOrder);
        $data['id'] = $res['id'];
