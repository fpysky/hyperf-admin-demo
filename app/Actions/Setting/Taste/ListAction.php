...
use App\Model\Taste;
use App\Resource\TasteResource;
...
class ListAction extends AbstractAction
{
    ...
    #[Get(path: '/taste', summary: '口味列表', tags: ['后台管理/页面设置/口味模块'])]
    ...
    public function handle(): ResponseInterface
    {
        ...
        $paginator = Taste::query()->paginate($pageSize);

        return $this->success([
            'list' => TasteResource::collection($paginator->items()),
