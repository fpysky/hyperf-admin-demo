...
{
    #[PostMapping(path: '/taste')]
    #[Post(path: '/taste', summary: '创建口味', tags: ['后台管理/页面设置/口味模块'])]
    ...
    public function handle(CreateRequest $request): ResponseInterface
    {
        ...
        $data = [
            ...
            'status' => Taste::STATUS_ENABLE,
        ];

        $taste = Taste::query()->create($data);

        foreach ($merchantIds as $merchantId) {
            TasteMerchant::query()->create([
                'taste_id' => $taste->id,
