...
export const usePermissionStore = defineStore('permission', () => {
  ...
  const generateRoutes = async (): Promise<RouteOption[]> => {
    ...
    const sidebarRoutes = filterAsyncRoutes(dynamicRoutes, sData);
    const rewriteRoutes = filterAsyncRoutes(dynamicRoutes, rData);
    const defaultRoutes = filterAsyncRoutes(dynamicRoutes, defaultData);
